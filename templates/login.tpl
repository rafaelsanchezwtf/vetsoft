            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 panellogin">
                ...
                <form class="form-horizontal" action="{$gvar.l_global}login.php?option=login" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-4">
                                <input onfocus='txt_onfocus(this);' {if isset($error2)} style="background: #F78181" {/if}  type="password" name="pass" class="form-control" id="inputPassword3" placeholder="Contraseña">
                            </div>
                        </div>
                    <div class="form-group">
