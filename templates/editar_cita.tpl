                    ...
                    <div class="camposeditar">
                      ...
                      <div class="camposeditar">
                        <div class="input-group">
                            ...
                            <input placeholder = "HH:MM" class="form-control " type="time" value="{$hora}" required name="hora" aria-describedby="basic-addon1" {if isset($hora_vacio) or isset($hora_invalido)} style="background-color: #F78181" {/if}>
                        </div>
                    </div> 
