    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form class="form-horizontal" action="{$gvar.l_global}adquirir_producto.php?option=agregar" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-6">
                        <h4>Precio x Unidad (COP)</h4>
                        <input type="text" {if isset($precio_unidad)}value="{$precio_unidad}"{/if} {if isset($precio_unidad_vacio) or isset($precio_unidad_invalido)} style="background-color: #F78181" {/if} class="form-control default_color" name="precio_unidad" placeholder="Precio Neto">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-6">
