        ...
        {if $tipo eq "administrador"}
            <form class="form-horizontal" action="{$gvar.l_global}asignar_cita.php?option=asignar_por_administrador" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-2">
                        <h4>Hora*</h4>
                        <input type="text" {if isset($hora_c)}value="{$hora_c}"{/if} {if isset($hora_c_vacio) or isset($hora_c_invalido)} style="background-color: #F78181" {/if} class="form-control default_color" name="hora" placeholder="YYY-mm-dd">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-6">
