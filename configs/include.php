...
define('C_FULL_PATH', 'C:/xampp/htdocs/vetsoft/'); //full path

define('C_L_GLOBAL', 'http://localhost/vetsoft/'); //application global link
...
define('C_DB_DATABASE_NAME', 'vetsoft'); //DB database name
