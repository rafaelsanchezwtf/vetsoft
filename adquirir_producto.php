...
class c_adquirir_producto extends super_controller {
    ...
    public function asignar_datos($nombre, $marca, $cantidad, $precio_unidad){
    ...
    public function asignar_vacios($nombre, $marca, $cantidad, $precio_unidad, $tipo){
        if (is_empty($nombre)){
        ...
        if (is_empty($precio_unidad)){
            $this->engine->assign("precio_unidad_vacio",0);
        }
   ...
   public function mensaje($icon, $type, $dir, $content){
    ...
    public function agregar(){
        self::asignar_datos($this->post->nombre,$this->post->marca,$this->post->cantidad,$this->post->precio_unidad);
        ...
        if ($incompletitud_producto){
            self::asignar_vacios($this->post->nombre,$this->post->marca,$this->post->cantidad,$this->post->precio_unidad,$this->post->tipo);
